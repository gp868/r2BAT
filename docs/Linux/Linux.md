...
![image-20220630151531650](../img/202206301515697.png)
...
![image-20220630151710633](../img/202206301517675.png)
...
![image-20220630151738354](../img/202206301517396.png)

没找到？没关系，你可以使用 grep 命令过滤掉一些你不想看到的结果：

`cat /etc/group | grep -E "shiyanlou"`

![image-20220630151751813](../img/202206301517847.png)
...
![image-20220630151815467](../img/202206301518506.png)
...
![image-20220630151858529](../img/202206301518568.png)


然后你再切换回 lilei 用户，现在就可以使用 sudo 获取 root 权限了。

![image-20220630151906094](../img/202206301519122.png)
...
![image-20220630151933885](../img/202206301519929.png)
...
![image-20220630151946450](../img/202206301519498.png)    


你可能除了知道最后面那一项是文件名之外，其它项就不太清楚了，那么到底是什么意思呢？

![image-20220630152017736](../img/202206301520765.png)


可能你还是不太明白，比如第一项文件类型和权限那一堆东西具体指什么，链接又是什么，何为最后修改时间，下面一一道来：

![image-20220630152031401](../img/202206301520443.png)
...
![image-20220630152053925](../img/202206301520962.png)
...
![image-20220630152104555](../img/202206301521599.png)
...
![image-20220630152125917](../img/202206301521947.png)
...
![image-20220630152213340](../img/202206301522370.png)
...
<img src="../img/202206301522090.png" alt="image-20220630152223046" style="zoom:40%;" />
...
![image-20220630152253116](../img/202206301522155.png)


切换到 lilei 用户，尝试写入和读取操作，可以看到 lilei 用户已经不能读写这个 iphone11 文件了：

![image-20220630152301244](../img/202206301523279.png)

🤞方式二：加减赋值操作

要完成上述实验相同的效果，你可以：`chmod go-rw iphone11`

![image-20220630152309781](../img/202206301523814.png)
...
![](../img/beff0f7e-807f-4fc6-8453-02110820c816.png)
...
![](../img/1c9fc4b5-1cc0-4fbc-8718-6b081cebe7ae.png)
...
![](../img/97d28ce4-25d0-4dbe-ace3-cabad86aaa3e.png)
...
![](../img/92dd2caa-bc90-4998-9f98-a7af7d780e9a.png)
...
![](../img/6b942238-e5a8-4a0f-9d30-45ef52986a65.png)
...
![](../img/625e8c80-afa2-4fc7-9ffa-da0f17c652b5.png)
...
![](../img/e66e1d96-39bf-459c-8608-e85f7b39b175.png)
...
![](../img/80736788-91d0-48fd-adee-b21ad82ac8b7.png)
...
![](../img/44ab3dc4-80b2-4937-a3fb-dbd24e1dcb42.png)
...
![](../img/ea886073-8061-4a2a-8887-12a938b51c27.png)
...
![](../img/96a1a9ac-5a5a-424f-87db-03f25d4d5bb1.png)
...
![](../img/85ea6618-7c37-4a0a-aa75-d0431da575b8.png)
...
file /bin/ls
```
![](../img/797b3d5c-c668-40d8-a1d0-dab5e83ac73c.png)
...
![](../img/56335591-8ddb-4d05-81ae-45d0e1c8b61b.png)
...
![](../img/35f63b42-424f-4e75-b640-28607f1806b2.png)
...
![](../img/e4d11f94-2027-4c83-9d99-fe55344301fe.png)
...
![image-20220630162715209](../img/image-20220630162715209.png)
...
![](../img/1fd6be23-a607-4382-9641-774f0c62e26a.png)
...
![](../img/9a453282-a001-4886-b58a-bb0e43c05748.png)
...
![](../img/616f63fb-4b83-41e3-9044-91548c6a45a3.png)
...
![](../img/001526e2-0585-40b5-bc5d-8f55eb305663.png)
...
unset mypath
```
![](../img/6dc075be-5f38-4a22-b728-e7ab8ac3adfc.png)
...
![](../img/2dca2b39-f05c-4185-953c-ac2b073a56fc.png)
...
![](../img/d5943c61-dc6b-4ef6-84e7-2508ebd2cd7a.png)
...
![](../img/5142a506-6ae3-40c5-8dbf-2b11b6d48401.png)
...
![](../img/1b36cb34-e5c9-42e7-ad26-ed3ca02cd7d5.png)
...
which ping
```
![](../img/1a3b095f-7d45-4854-8371-fe36fbd0911c.png)
...
![](../img/402a8de3-3937-451f-8755-798460d866f6.png)
...
<img src="../img/d1d3e3f3-26b0-4e6c-88d5-1ddb53915451.png" style="zoom:70%;" />
...
![](../img/1af6123e-008d-4120-8561-0bb3d74eb8d2.png)
...
![](../img/39977be1-c990-445d-8164-5ad74e906a81.png)
...
![](../img/882ceef6-2f1e-4846-bc8a-fc06f03798db.png)
...
![](../img/9660fdfe-bc42-40f6-994f-fdbda4ec6746.png)
...
![](../img/545214aa-5266-4e80-8bd1-d26dfbc4d5dc.png)

但在实际的物理主机上会更像这样：
![](../img/fdac732e-6429-4a22-90a4-55b46ca40779.png)
...
![](../img/6498735f-d0f6-4836-a595-ac17f4af811f.png)
...
![](../img/1bf3d76f-7e8d-4083-b1bf-9a81db3e9007.png)
...
![](../img/42a81eec-cbd2-43e4-9d7e-11cb536a3a94.png)
...
![](../img/6f060d38-0f04-47a7-b3af-e0a5c00e0042.png)
...
![](../img/7b51bc56-2108-4829-a058-bb8ebb1a3db9.png)
...
![](../img/6bdf3474-aa10-4ce6-b61d-9cda7868a534.png)
...
![](../img/c97825dc-a127-40c7-adb4-0b0f96b923fb.png)
...
![](../img/0e0dddc4-580b-42f2-a095-b911b96c52ed.png)
...
![](../img/f90d5d4a-8735-4983-add6-5e4792ca70ae.png)
...
![](../img/a3b4720e-d56e-4def-9ba5-f7de0d88bc31.png)

画个流程图来解释一下上面的流程：

![](../img/244717d2-71ba-4f08-98f1-c6746ef1110a.png)
...
![](../img/647c2b95-c02d-4c16-88ad-27e150dbe2af.png)
...
![](../img/64a91d0e-4190-4879-b8a2-51573afa090a.png)
...
![](../img/ac492769-8923-4be6-81cf-2f45e23f972c.png)
...
![](../img/7d704c16-cc05-4b30-a590-b3783e15bfe3.png)
...
![](../img/0000e869-bca1-4573-afb7-7dfed461fc0b.png)
...
![](../img/f6b3c016-a990-4e00-b2a2-1f765fa00a87.png)
...
```
![](../img/fa5376ba-ebe0-4600-8b60-8b313b17368b.png)
...
```
![](../img/3b695b2e-db84-479b-a7e6-ebb8450088b3.png)
...
![](../img/589de178-fd48-4d86-a1a7-d534e7d82b6a.png)

![](../img/dc75b09d-ddba-4daa-aa84-4eb5138df0ac.png)
...
```
![](../img/076e18d7-7d9f-4969-a2c5-8fa6d19b581b.png)
...
![](../img/064797b5-4cdd-4293-85a6-9d2fa193c59f.png)
...
```
![](../img/2ae92db1-aa86-40ef-8e3e-2b76bfc24d8a.png)
...
![](../img/ac4540f4-452d-4002-a4bc-777a1bb05b39.png)
...
![](../img/a56075d8-2a52-46dc-bc2d-19f6c130421d.png)
...
cat somefile
```
![](../img/b64c5a0d-a56f-4a50-ae65-b6eedd373b39.png)
...
exit
```
![](../img/cc487579-057c-4bde-9117-c9c0b01344a1.png)
...
![](../img/36df5bf1-dd99-4a32-8c01-0078904e7daf.png)
...
![](../img/bb1f0b87-8206-404d-84cf-7ddd0c653252.png)
...
![](../img/582137d3-1cdb-4211-a64e-7cfbc2e3411c.png)
...
![](../img/e7956578-a977-4a5f-865a-1df22ca4e289.png)
...
![](../img/9e6c02ba-f429-4ede-ad25-539f101f325d.png)
...
![](../img/cd84cf3c-7cb3-4b66-bf88-c46b37aa8091.png)
...
# nl命令作用是添加行号
```
![](../img/0be2e9e1-e589-4c49-97a7-163dfc3f9827.png)
...
![](../img/395773e1-ff02-4fc7-8f51-76e396115fc4.png)
...
![](../img/3eea2e6e-b546-4aa5-ba83-f067491fe853.png)
...
![](../img/1382af4e-072a-4eef-aea7-77da39d2069a.png)
...
![](../img/1d4ce074-6333-4418-8d74-e87ef35abc7f.png)
...
![](../img/3088e5a9-119e-4508-857d-c21e340062e2.png)
...
![](../img/68cc9f9f-e158-4421-87ed-d7c764785154.png)
...
![](../img/167993cf-df85-4816-b394-fd166f8cfcbc.png)
...
![](../img/8346731b-e109-4d18-86fe-a558af96d98d.png)
...
![](../img/feb3405c-dc55-4101-8503-2cd858151d12.png)
...
![](../img/d3ec3bd4-bdda-428e-ba9f-ec832b72791e.png)

或者从此图我们可以更加形象的看清子父进程的关系


![](../img/260175bc-fb97-446e-964c-261549a92a01.png)
...
![](../img/01b8333b-a4fd-4c7d-ada8-bf77712442d6.png)
...
![](../img/e22d8608-4313-46d0-9ebf-3fadcc3d4969.png)

图中所显示的 [1] 236分别是该 job 的 job number 与该进程的 PID，而最后一行的 Done 表示该命令已经在后台执行完毕。

我们还可以通过 `ctrl + z` 使我们的当前工作停止并丢到后台中去

![](../img/901d744e-10cc-4589-8010-6f032cf13f3d.png)

被停止并放置在后台的工作我们可以使用 `jobs` 命令来查看：

![](../img/a7021dc2-875f-4481-88c7-c4d8d5f161f6.png)
...
![](../img/9943422f-40ec-4134-a2c9-addd0b73fc3e.png)

![](../img/507cd882-8e4d-456c-9c3c-576eabd8e50d.png)
...
![](../img/a5e6d61e-c0ff-4a56-8653-ca65e5fdc888.png)
...
![](../img/eb13a1d5-2f3b-45d2-8794-84c3ea7df62b.png)
...
![](../img/01fde29a-9774-4b99-8ac2-c5ef0252558f.png)
...
![](../img/ba043cff-a52f-4db2-a9c4-d778cb810aae.png)

```php
ps axjf
```

![](../img/3889fa80-5cbc-4c5f-bc40-769901c181fc.png)
...
![](../img/56872c4d-d5b8-49de-9e19-304e54069ce1.png)
...
![](../img/a08178f6-9542-4f5e-9113-00dc49706924.png)
...
![](../img/e96466b1-cebc-4105-9b29-6e33068be22a.png)
...
![](../img/5f11c56b-242d-48e2-add3-0376d8a61380.png)
...
![](../img/f6c99da1-2fbf-4cda-a184-514cca48a16f.png)

### pstree 工具的使用
通过 `pstree` 可以很直接的看到相同的进程数量，最主要的还是我们可以看到所有进程之间的相关性。

![](../img/0049a8c4-0c6c-421d-8ee4-123662a8dc35.png)
...
![](../img/0ed4bd8a-3164-4e63-9ea5-2c7e2425a48c.png)
...
ps aux | grep gedit
```
![](../img/b90949ba-7283-4dea-9364-ed0c55558dcc.png)

![](../img/b58db2e2-03b5-4865-b5b8-5ebe34765b80.png)
