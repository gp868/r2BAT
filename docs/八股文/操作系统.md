...
- 内核如何将数据拷贝到用户缓冲区：
  ...
  [这是一份很全很全的 IO 基础知识与概念 (qq.com)](https://mp.weixin.qq.com/s/csgfmUs6wZ1TQr8P7IcqEg)

  [内核缓冲区与用户缓冲区 - 走看看 (zoukankan.com)](http://t.zoukankan.com/BlueBlueSea-p-14807245.html)
