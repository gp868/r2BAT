...
<img src="https://test1.jsdelivr.net/gh/gp868/myFigures/img/202207161501747.png" alt="image-20220716150056532" style="zoom:60%;" />

使用 `peek` 或 `pop` 操作队头的元素时，若 `s2` 为空，可以把 `s1` 的所有元素取出再添加进 `s2`，这时候 `s2` 中元素就是先进先出顺序了：

<img src="https://test1.jsdelivr.net/gh/gp868/myFigures/img/202207161503075.png" alt="image-20220716150313819" style="zoom:50%;" />
...
<img src="https://test1.jsdelivr.net/gh/gp868/myFigures/img/202207161539354.png" alt="括号匹配1" style="zoom:80%;" />

2. 括号没有多余，但是括号的类型没有匹配上。 

<img src="https://test1.jsdelivr.net/gh/gp868/myFigures/img/202207161539363.png" alt="括号匹配2" style="zoom:80%;" />

3. 字符串里右方向的括号多余了，所以不匹配。 

<img src="https://test1.jsdelivr.net/gh/gp868/myFigures/img/202207161539183.png" alt="括号匹配3" style="zoom:80%;" />
