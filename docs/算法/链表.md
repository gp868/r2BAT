...
<img src="../img/202204301513096.jpeg" alt="img" style="zoom:50%;" />
...
<img src="../img/202204301537463.gif" alt="1" style="zoom:50%;" />
...
<img src="../img/202205101321822.jpeg" alt="img" style="zoom:50%;" />
...
<img src="../img/202205101328225.png" alt="image.png" style="zoom:80%;" />
...
<img src="../img/202205111119176.jpeg" alt="img" style="zoom:50%;" />
...
<img src="../img/202205051454870.png" alt="image-20220505145454803" style="zoom:70%;" />

趁这个时候，再用一个指针 `p2` 指向链表头节点 `head`，此时若把`p1`当作链表尾部的`NULL`，则`p2` 就是倒数第`k`个节点。：

<img src="../img/202205051459242.png" alt="image-20220505145900194" style="zoom:65%;" />

那如何让`p1`成为真正的尾节点而且`p1`和`p2`之间的位置关系保持不变呢？俩指针一同向后移动呗，直到`p1 == NULL`为止，此时`p1`就是真正的倒数第`k`个节点。

<img src="../img/202205051501166.png" alt="image-20220505150130107" style="zoom:60%;" />
...
<img src="../img/202205051516856.jpeg" alt="img" style="zoom:50%;" />
...
<img src="../img/202205051537983.png" alt="img" style="zoom:50%;" />
...
<img src="../img/202205051547660.png" alt="img" style="zoom:50%;" />
...
<img src="../img/202205051554426.png" alt="image-20220505155433363" style="zoom:60%;" />
...
<img src="../img/202205051555842.png" alt="image-20220505155537778" style="zoom:65%;" />
...
<img src="../img/202205080908373.jpeg" alt="img" style="zoom:50%;" />
...
<img src="../img/202205080927213.png" alt="image-20220508092702168" style="zoom:70%;" />
...
<img src="../img/202205080928389.png" alt="image-20220508092851331" style="zoom:60%;" />

`reverseList(head->next)` 执行完成后，整个链表就成了这样：

<img src="../img/202205080930542.png" alt="image-20220508093035486" style="zoom:80%;" />
...
<img src="../img/202205080931640.png" alt="image-20220508093159593" style="zoom:70%;" />
...
<img src="../img/202205080933837.png" alt="image-20220508093304789" style="zoom:70%;" />
...
<img src="../img/202205080949720.jpeg" alt="img" style="zoom:50%;" />
...
<img src="../img/202205080941826.png" alt="image-20220508094103751" style="zoom:60%;" />
...
<img src="../img/202205080944191.png" alt="image-20220508094450123" style="zoom:60%;" />
...
<img src="../img/202205091351001.jpeg" alt="img" style="zoom:50%;" />
...
<img src="../img/202205101114825.png" alt="image-20220510111404759" style="zoom:80%;" />

打羊胎素展开链表：

<img src="../img/202205101115513.png" alt="image-20220510111531466" style="zoom:80%;" />
...
<img src="../img/202205081042731.jpeg" alt="img" style="zoom:50%;" />
...
<img src="../img/202205081131992.png" alt="image-20220508113128936" style="zoom:60%;" />

**2、将第 `k + 1` 个元素作为 `head` 递归调用 `reverseKGroup` 函数**。

<img src="../img/202205081133011.png" alt="image-20220508113301946" style="zoom:65%;" />

**3、将上述两个过程的结果连接起来**。

<img src="../img/202205081134446.png" alt="image-20220508113408376" style="zoom:70%;" />

**4、最后函数递归完成之后就是这个结果，完全符合题意：**

<img src="../img/202205081135250.png" alt="image-20220508113522192" style="zoom:70%;" />
...
<img src="../img/202205081154922.gif" alt="8" style="zoom:40%;" />

### 61. 旋转链表

给你一个链表的头节点 `head `，旋转链表，将链表每个节点向右移动 `k `个位置。

<img src="../img/202205101131379.jpeg" alt="img" style="zoom:50%;" />
...
<img src="../img/202205101146039.png" alt="image-20220510114658985" style="zoom:60%;" />

2、由于`k`可能很大，所以我们令 `k = k % n`，然后再次从头节点`head`开始遍历，找到第`n - k`个节点p，那么1 ~ p是链表的前 `n - k`个节点，p+1 ~ n是链表的后`k`个节点。

<img src="../img/202205101148095.png" alt="image-20220510114840024" style="zoom:60%;" />
...
<img src="../img/202205101152961.png" alt="image-20220510115248903" style="zoom:60%;" />
...
<img src="../img/202205102108369.png" alt="image-20220510210809294" style="zoom:70%;" />

<img src="../img/202205102110174.png" alt="image-20220510211017122" style="zoom:70%;" />
...
<img src="../img/202205102114649.jpeg" alt="img" style="zoom:40%;" />
...
<img src="../img/202205111006447.png" alt="Picture2.png" style="zoom:40%;" />
...
<img src="../img/202205081046989.jpeg" alt="img" style="zoom:60%;" />
...
<img src="../img/202205091153464.png" alt="image-20220509115340350" style="zoom:60%;" />

2、如果`fast`指针没有指向`null`，说明链表长度为奇数，`slow`还要再前进一步：

<img src="../img/202205091155968.png" alt="image-20220509115524911" style="zoom:60%;" />

3、从`slow`开始反转后面的链表，现在就可以开始比较回文串了：

<img src="../img/202205091156704.png" alt="image-20220509115621642" style="zoom:50%;" />
...
<img src="../img/202205091330784.jpeg" alt="img" style="zoom:50%;" />
...
<img src="../img/202205101206051.jpeg" alt="img" style="zoom:50%;" />
...
<img src="../img/202205111138200.png" alt="img" style="zoom:50%;" />
...
<img src="../img/202205051608009.png" alt="img" style="zoom:50%;" />



这题难点在于，由于两条链表的长度可能不同，两条链表之间的节点无法对应：

<img src="../img/202205051844252.png" alt="image-20220505184443179" style="zoom:50%;" />
...
<img src="../img/202205051848637.png" alt="image-20220505184819556" style="zoom:50%;" />
