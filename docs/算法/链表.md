...
<img src="https://gcore.jsdelivr.net/gh/gp868/myFigures/img/202205081131992.png" alt="image-20220508113128936" style="zoom:60%;" />

**2、将第 `k + 1` 个元素作为 `head` 递归调用 `reverseKGroup` 函数**。

<img src="https://gcore.jsdelivr.net/gh/gp868/myFigures/img/202205081133011.png" alt="image-20220508113301946" style="zoom:65%;" />

**3、将上述两个过程的结果连接起来**。

<img src="https://gcore.jsdelivr.net/gh/gp868/myFigures/img/202205081134446.png" alt="image-20220508113408376" style="zoom:70%;" />

**4、最后函数递归完成之后就是这个结果，完全符合题意：**

<img src="https://gcore.jsdelivr.net/gh/gp868/myFigures/img/202205081135250.png" alt="image-20220508113522192" style="zoom:70%;" />
...
<img src="https://gcore.jsdelivr.net/gh/gp868/myFigures/img/202205081154922.gif" alt="8" style="zoom:40%;" />
