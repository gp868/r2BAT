...
![img](https://cdn.jsdelivr.net/gh/CARLOSGP2021/myFigures/img/202205101321822.jpeg)
...
<div align=centre><img src="https://cdn.jsdelivr.net/gh/CARLOSGP2021/myFigures/img/202205101328225.png" alt="image.png" style="zoom:80%;" /></div>
...
- `pre`和`cur`指针都要向后移动，所以还要记录`cur`后一个节点的指针`tmp`；
...
<div align=center><img src="https://cdn.jsdelivr.net/gh/CARLOSGP2021/myFigures/img/202205101148095.png" alt="image-20220510114840024" style="zoom:60%;" />
...
- 找到原链表的中点（参考「876. 链表的中间结点」），使用快慢指针来 O(N)O(N) 地找到链表的中间节点。
